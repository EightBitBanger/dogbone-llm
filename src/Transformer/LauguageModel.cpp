...
Tensor2D LauguageModel::Forward(const std::vector<int>& ids, float* scratch) const {
...
bool LauguageModel::SaveToStream(std::ostream& out) const {
...
bool LauguageModel::LoadFromStream(std::istream& in) {
    ...
    *this = LauguageModel(V, DM, H, DFF, L, MT);
...
bool LauguageModel::Save(const std::string& path) const {
...
bool LauguageModel::Load(const std::string& path) {
